...
/// <summary>
/// Completely rebuilds SettingsCanvas in all scenes from scratch,
/// ensuring all references are properly serialized.
/// All Image types are set to Simple. All Button targetGraphics are set.
/// </summary>
public class RebuildAllCanvases
{
    ...
    public static string Execute()
    {
        ...
        foreach (var (path, isGarden) in scenes)
        {
            ...
            // Remove existing SettingsCanvas
            ...
            result += $"Rebuilt SettingsCanvas in: {scene.name} (isGarden={isGarden})\n";
        }
    ...
    private static GameObject BuildCanvas(bool isGardenScene)
    {
        ...
        // Resume: in garden scene goes to -475 (same as MainGarden), in minigames goes to -560
        ...
        // ===== Add wiring component and wire references =====
        ...
        string spriteAssetPath, Vector2 position, Vector2 size)
    {
        ...
        // Add Button and explicitly set targetGraphic
        ...
        // Force serialize the targetGraphic
    ...
    private static GameObject BuildBlueSlider(Transform parent, string name, Vector2 position)
    {
        ...
        // Add Slider component and wire references
